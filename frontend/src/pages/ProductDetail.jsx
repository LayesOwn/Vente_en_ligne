          ...
          >
            ...
            {profile?.phone && (() => {
              ...
              const msg = encodeURIComponent(
                `Bonjour, je suis intéressé(e) par ce produit : ${product.name} (${product.price.toLocaleString()} FCFA). Est-il disponible ?`
              );
              return (
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-4 mb-4 text-base font-medium text-white rounded-sm transition-colors"
